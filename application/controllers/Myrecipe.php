...
class Myrecipe extends CIF_Controller {
    ...
    public function manage($id = FALSE) {
        ...
        $this->form_validation->set_rules('serves', 'Serves', 'trim');
        ...
        $this->form_validation->set_rules('calories', 'Calories', 'trim');
        ...
        $this->form_validation->set_rules('video', 'Video Link', 'trim');
