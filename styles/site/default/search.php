    ...
    <div class="container">
        <div class="sixteen columns">
            <div id="advanced-search">
                <form action="<?php echo site_url('recipes/search') ?>" id="search-customers" class="edit-profile">
                    <!-- Choose Category -->
                    <div class="select">
...
<div class="container">
    ...
    <!-- Headline -->
    <div class="sixteen columns">
        <h3 class="headline">Search Results</h3>
        <span class="line margin-bottom-35"></span>
        <div class="clearfix"></div>
    </div>
    <div class="clearfix"></div>
    <div class="search-result-message">SEARCH RESULTS FOR: <b><?php echo set_value('title') ?> </b> <?php if (set_value('category_id')): ?> in category: <b>  <?php echo $this->db->where("category_id", set_value('category_id'))->get("categories")->row()->title ?></b><?php endif ?></div>
    <?php if (!$items): ?>
        <div class="search-result-message error">
            NO RESULTS HAVE BEEN FOUND, TRy to search again with different word
        </div>
    <?php endif; ?>
    <!-- Isotope -->
    <div class="isotope">
